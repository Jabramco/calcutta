      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6 bg-[#15151e] p-8 rounded-2xl border border-[#2a2a38]" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-medium text-[#a0a0b8] mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <input
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-semibold rounded-xl text-[#0d0d14] bg-[#00ceb8] hover:bg-[#00b5a1] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00ceb8] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
          ...
          <div className="text-center">
            <Link href="/login" className="text-sm text-[#00ceb8] hover:text-[#00b5a1] font-medium transition-colors">
